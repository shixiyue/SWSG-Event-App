...
class Events {
    ...
    private init() {
        /*events = [Date.date(from: "2017 04 05"): [Event(images: [UIImage](), name: "Check-In Registration", start_datetime: "", end_datetime:"", venue: "Outside Meeting Room 1", description: "Please register and collect your breakfast outside Meeting Room 1", details: "Kindly get all your members to register Outside Meeting Room 1 to collect your daily pass and Wi-Fi password. \nPlease bring a photo ID for identification, duplicates are not accepted. Each member has to be present at the registration"),
                                                  Event(images: [UIImage](), name: "Morning Keynote", start_datetime:  "2017 04 05", end_datetime: "2017 04 05", venue: "Theatre 3", description: "Mr Saravanan (Google Singapore) will be given a talk on Cloud Computing and Software as a Service", details: "blah blah blah")],
                  Date.date(from: "2017 04 06"): [Event(images: [UIImage](), name: "Morning Keynote", start_datetime: "2017 04 05", end_datetime: "2017 04 06", venue: "Theatre 3", description: "Mr Saravanan (Google Singapore) will be given a talk on Cloud Computing and Software as a Service", details: "blah blah blah"),
                                                  Event(images: [UIImage](), name: "Morning Keynote", start_datetime: "2017 04 06", end_datetime: "2017 04 05", venue: "Theatre 3", description: "Mr Saravanan (Google Singapore) will be given a talk on Cloud Computing and Software as a Service", details: "blah blah blah")]]*/
    }
